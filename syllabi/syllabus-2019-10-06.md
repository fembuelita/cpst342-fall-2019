...
Consult Sakai calendar and ZyBooks for detailed breakdowns and due dates, but in general:
...
* Assignment: Building and deploying your first website

#### Unit 2

* Readings: Chapters 4, 5, 6
* Languages Learned: CSS/SASS
* Tools Learned: NPM (basic), SASS Compiler
...
* 
* Languages: Client-side JavaScript (various versions)
* Tools: Gulp, MomentJS, NPM
* Frameworks: 
